namespace AngelHack2016.Migrations
{
    ...
    public partial class init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        AnalyzedFeedbackId = c.Int(),
                        SentimentScore = c.Single(),
                ...
                c => new
                    {
                        ...
                        Industry = c.String(),
                        Username = c.String(),
                        maxTransactionNumber = c.Int(nullable: false),
                        minTransactionNumber = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Feedbacks", "BusinessId", "dbo.Businesses");
            ...
            DropIndex("dbo.Feedbacks", new[] { "BusinessId" });
